import { X, MapPin, AlertTriangle, ThermometerSun, Wind, Droplets, Activity } from 'lucide-react';
    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className="relative w-full max-w-4xl max-h-[90vh] overflow-hidden rounded-2xl border bg-[#0a0f1a] shadow-2xl"
          style={{
        ...
        >
          ...
          <button
            onClick={onClose}
            className="absolute top-6 right-6 p-2 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 transition-colors z-10"
          >
          ...
          <div className="overflow-y-auto max-h-[calc(90vh-0.5rem)]">
            <div className="p-8">
              ...
              {/* Severity Badge */}
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg mb-6 border"
                style={{
              ...
              <div className="mb-8">
                ...
                <div className="relative rounded-lg overflow-hidden border border-white/10">
                  ...
                  {/* Overlay for BioPulse aesthetic */}
                ...
                {/* Optional: additional image source if available */}
              ...
              >
                ...
                <p className="text-white/80 leading-relaxed">
                  ...
                  The affected region spans approximately {event.affectedArea.toLocaleString()} square kilometers
                  {event.affectedPopulation && ` with ${event.affectedPopulation.toLocaleString()} people at risk`}.
                  Continuous monitoring is in effect, and real-time data is being collected from multiple sensors and satellite systems.
                </p>
              </div>
            </div>
          </div>
