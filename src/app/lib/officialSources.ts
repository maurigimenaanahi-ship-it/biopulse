...
export const OFFICIAL_SOURCE_REGISTRY: OfficialSourceRecord[] = [
  ...
  {
    id: "gdacs-ercc",
    name: "Referencia internacional de desastres",
    provider: "GDACS / ERCC",
    ...
    currentUse: "BioPulse puede usar GDACS como referencia global de contexto, pero no como alerta local principal.",
    nextStep: "Mantenerlo como respaldo internacional y priorizar fuentes oficiales locales comprensibles para la persona usuaria.",
  },
  {
    id: "cap-official-alerts",
    name: "Servicio Meteorologico Nacional",
    provider: "Servicio Meteorologico Nacional",
    kind: "official_alert",
    authority: "official_government",
    status: "connected",
    url: "https://www.alert-hub.org/fah",
    attribution: "Servicio Meteorologico Nacional, via Alert-Hub",
    provides: [
      "Alertas meteorologicas oficiales",
      "Vigencia, severidad, certeza, descripcion, recomendaciones y area afectada",
    ],
    doesNotProvide: [
      "Ordenes locales de evacuacion salvo que la fuente lo indique explicitamente",
      "Observacion satelital directa",
      "Memoria comunitaria",
      "Contexto historico completo",
    ],
    currentUse: "BioPulse consulta el canal nacional de alertas meteorologicas de Argentina via Alert-Hub y normaliza alertas del Servicio Meteorologico Nacional cercanas al evento.",
    nextStep: "Sumar defensa civil nacional, provincial o municipal para ordenes operativas y evacuaciones cuando existan feeds confiables.",
  },
  {
    id: "guardian-local",
    name: "Guardian Local",
